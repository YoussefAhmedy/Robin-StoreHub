...
export const ALL_PRODUCTS = [
  ...
  { id:5, name:'Crab Crewneck', slug:'crab-crewneck', description:'Black crewneck with a large red crab embroidery across the chest. Limited run.', materials:'100% heavyweight cotton', fitNotes:'True to size', price:1200, discountPrice:null, imageUrl:'https://res.cloudinary.com/dkh59ytfc/image/upload/v1776122471/Crab_Crewneck_2_fd8ypk.png', imageUrlsJson:'["https://res.cloudinary.com/dkh59ytfc/image/upload/v1776122471/Crab_Crewneck_2_fd8ypk.png"]', sizesJson:'["S","M","L","XL"]', colorTags:'black,red', gender:'Men', season:'AllSeason', subCategory:'Sweatshirt', ageGroup:null, isTrending:false, isAvailable:false, stockQuantity:0, category:{id:2,name:'Tops'}, avgRating:0, reviewCount:0 },
